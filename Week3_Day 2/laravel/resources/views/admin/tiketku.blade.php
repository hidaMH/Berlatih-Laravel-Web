            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <!--  <li>
                    ...
                    <li>
                        <a href="listevent.html" class="waves-effect waves-dark"><i class="fa fa-table"></i> List event</a>
                    </li>
                     <li>
                        <a href="tiketku.html" class="active-menu waves-effect waves-dark"><i class="fa fa-table"></i> Tiket Saya</a>
                    </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>15 Agustus</td>
                                            <td><button>cancel</button> <button><a href="../../detail_tiket.html">lihat</a></button></td>
